...
extern int scanhash_x8r(int thr_id, struct work* work, uint32_t max_nonce, unsigned long *hashes_done);
...
extern void free_x8r(int thr_id);
...
void x8r_hash(void *output, const void *input);
